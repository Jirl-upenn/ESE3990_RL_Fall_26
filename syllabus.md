...
## Textbooks
There is no need buy any textbook for this course. We will provide slides or lecture notes in this course. A lot of the material we cover originates from the following two books: 
...
We encourage you to make use of campus resources like Penn GSE Student Success to assist you in your pursuit of
...
## Late Policy
The only time when students have to submit something for this class is for the final presentation. The event will be live, so not presenting on time will be equivalent to a fail grade. Not coming to the midterm will result to a fail grade. No exceptions will be granted.    
...
## Grading
Grading details will be provided in the slides from the first class. Overall, your final grade will be based on a combination of exams and your project presentation.
